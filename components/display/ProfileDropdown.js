...
function ProfileDropdown() {
    ...
    return (
        <div className="flex flex-col relative h-full">
            <button
                type="button"
                className="h-full flex justify-center w-28 items-center rounded:lg"
            ...
            {click && <div className="absolute w-48 text-orange-400 bg-gray-800 translate-y-14 -translate-x-20">
                <Link href="/problems">
                    <a className="flex p-2 w-full rounded:lg hover:bg-gray-700" >
