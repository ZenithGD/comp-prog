...
const Card = ({ title, desc, photo, tags, to }) => {
    return (
        <Link href={to}>
            <a className='filter drop-shadow-md bg-gray-800 rounded-lg w-full flex justify-center items-start flex-col transition transform duration-200 hover:scale-105'>
